...
$(document).on('click','.send_form', function(){
  ...
  var input_blanter2 = document.getElementById('subjek');
  var input_blanter3 = document.getElementById('pesan');
  ...
  if("" != input_blanter.value && input_blanter1.value && input_blanter2.value && input_blanter3.value){
  
   /* Call Input Form */
  var input_nama = $("#nama").val(),
      input_email = $("#email").val(),
      input_subjek = $("#subjek").val(),
      input_textpesan = $("#pesan").val();
  
  /* Final Whatsapp URL */
  var blanter_whatsapp = walink + '?phone=' + phone + '&text=' + header  + input_nama + '%0A%0A' +
      '*Email* : ' + input_email + '%0A' +
      '*Subjek* : ' + input_subjek + '%0A' +
      '*Pesan* : ' + input_textpesan + '%0A' +
      footer + '%0A';
